...
public class JSONDiffTesting {
    ...
    public void testJSONObjectAddition() throws JSONException {
        ...
        assertTrue(JSONUtils.isEquivalent(expectedAddition,actualDiff.getAdded()));
    }
    ...
    public void testJSONObjectRemoval() throws JSONException {
        ...
        assertTrue(JSONUtils.isEquivalent(expectedDeletion,actualDiff.getRemoved()));
    }

    @Test
    public void testEquivalency() throws JSONException {
        JSONObject obj1 = new JSONObject("{ \"_id\": \"56cb4903b342343cf23169b3\", \"index\": 0, \"guid\": \"ad534049-1741-4ac6-84ae-0d6ad0220ef0\", \"isActive\": true, \"physical\": { \"age\": 33, \"eyeColor\": \"brown\" }, \"balance\": \"$1,386.23\", \"contact\": { \"email\": \"bartlettbond@zillanet.com\", \"phone\": \"+1 (907) 488-3623\", \"address\": \"178 Ditmars Street, Nescatunga, Texas, 3538\" }, \"name\": \"Hammond Palmer\", \"gender\": \"male\", \"company\": \"VELITY\", \"about\": \"Enim ea sunt est irure laboris elit adipisicing eu fugiat elit. Ut Lorem proident eiusmod consequat ea elit occaecat dolor sit sit ut. Labore qui nostrud nulla amet amet aliquip labore id minim laborum occaecat. Pariatur velit aute cupidatat ullamco aliqua irure pariatur veniam velit cupidatat esse. Veniam ullamco esse voluptate non eiusmod non. Pariatur deserunt ea ea commodo reprehenderit ex reprehenderit in irure dolore voluptate.\\r\\n\", \"latitude\": -47.901861, \"longitude\": -103.258658, \"greeting\": \"Hello, Hammond Palmer! You have 9 unread messages.\", \"favoriteFruit\": \"apple\" }");
        JSONObject obj2 = new JSONObject("{ \"_id\": \"56cb4903b342343cf23169b3\", \"index\": 0, \"guid\": \"ad534049-1741-4ac6-84ae-0d6ad0220ef0\", \"isActive\": true, \"physical\": { \"eyeColor\": \"brown\", \"age\": 33\n" +
                "\n" +
                " }, \"balance\": \"$1,386.23\", \"contact\": { \"address\": \"178 Ditmars Street, Nescatunga, Texas, 3538\", \"email\": \"bartlettbond@zillanet.com\", \"phone\": \"+1 (907) 488-3623\" }, \"name\": \"Hammond Palmer\", \"gender\": \"male\", \"company\": \"VELITY\", \"latitude\": -47.901861, \"about\": \"Enim ea sunt est irure laboris elit adipisicing eu fugiat elit. Ut Lorem proident eiusmod consequat ea elit occaecat dolor sit sit ut. Labore qui nostrud nulla amet amet aliquip labore id minim laborum occaecat. Pariatur velit aute cupidatat ullamco aliqua irure pariatur veniam velit cupidatat esse. Veniam ullamco esse voluptate non eiusmod non. Pariatur deserunt ea ea commodo reprehenderit ex reprehenderit in irure dolore voluptate.\\r\\n\", \"longitude\": -103.258658, \"greeting\": \"Hello, Hammond Palmer! You have 9 unread messages.\", \"favoriteFruit\": \"apple\" }");
        assertTrue(JSONUtils.isEquivalent(obj1,obj2));
    }

    @Test
    public void testComplexRemovalsAdditionsChanged() throws JSONException {
        JSONObject originalObject = new JSONObject("{ \"_id\": \"56cb67fc7aff6dfa27e9f844\", \"index\": 0, \"guid\": \"cd8bd9af-3769-4273-a181-9fd2cd27d500\", \"isActive\": false, \"physical\": { \"age\": 31, \"eyeColor\": \"brown\" }, \"balance\": \"$3,295.30\", \"contact\": { \"email\": \"valeriariley@qaboos.com\", \"phone\": \"+1 (945) 438-2381\", \"address\": \"637 Seeley Street, Kohatk, Kentucky, 279\" }, \"name\": \"Benton Baxter\", \"gender\": \"male\", \"company\": \"SURETECH\", \"about\": \"In dolor cupidatat laborum enim. Et ullamco laboris enim velit velit sit qui sit ex velit. Commodo do ullamco exercitation duis ut et. Anim labore excepteur enim laboris. Id labore consequat aute ut non id labore nisi velit enim reprehenderit quis.\\r\\n\", \"latitude\": -35.538156, \"longitude\": 95.072343, \"greeting\": \"Hello, Benton Baxter! You have 1 unread messages.\", \"favoriteFruit\": \"banana\" }");
        JSONObject changedObject = new JSONObject("{ \"_id\": \"56cb67fc7aff6dfa27e9f844\", \"index\": 0, \"guid\": \"cd8bd9af-3769-4273-a181-9fd2cd27d500\", \"isActive\": false, \"physical\": { \"age\": 31, \"height\": 50 }, \"balance\": \"$3,295.30\", \"contact\": { \"email\": \"valeriariley@qaboos.com\", \"address\": \"637 Seeley Street, Kohatk, Kentucky, 279\", \"cell\": { \"home\": 500, \"work\": 600 } }, \"name\": \"Benton Baxter\", \"gender\": \"male\", \"company\": \"SURETECH\", \"about\": \"In dolor cupidatat laborum enim. Et ullamco laboris enim velit velit sit qui sit ex velit. Commodo do ullamco exercitation duis ut et. Anim labore excepteur enim laboris. Id labore consequat aute ut non id labore nisi velit enim reprehenderit quis.\\r\\n\", \"latitude\": -35.538156, \"longitude\": 100, \"greeting\": \"Hello, Benton Baxter! You have 1 unread messages.\", \"favoriteFruit\": \"banana\" }");
        JSONObject expectedRemovals = new JSONObject("{ \"physical\": { \"eyeColor\": \"REMOVED\" }, \"contact\": { \"phone\": \"REMOVED\" } }");
        JSONObject expectedAdditions = new JSONObject("{ \"physical\": { \"height\": 50 }, \"contact\": { \"cell\": { \"home\":500, \"work\":600 } } }");
        JSONObject expectedChanges = new JSONObject("{}");
        JSONDiff diff = JSONUtils.getDiff(originalObject,changedObject);
        assertTrue(String.format("%s is not equivalent to %s",expectedRemovals.toString(),diff.getRemoved().toString()),JSONUtils.isEquivalent(expectedRemovals,diff.getRemoved()));
        assertTrue(String.format("%s is not equivalent to %s",expectedAdditions.toString(),diff.getAdded().toString()),JSONUtils.isEquivalent(expectedAdditions,diff.getAdded()));
        assertTrue(String.format("%s is not equivalent to %s",expectedChanges.toString(),diff.getChanged().toString()),JSONUtils.isEquivalent(expectedChanges,diff.getChanged()));
    }
