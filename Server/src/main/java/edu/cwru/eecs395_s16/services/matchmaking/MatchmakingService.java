...
public interface MatchmakingService {
    InternalResponseObject<Boolean> queueAsHeroes(Player p, QueueHeroesRequest request);

    InternalResponseObject<Boolean> queueAsArchitect(Player p, QueueArchitectRequest request);
